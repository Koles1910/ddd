...
/*               
        ...
        GAME.parseQuickOpts = function (newq_bar = false) {
            ...
            if (newq_bar || GAME.char_id) {
                ...
                opts += `<div class="qlink load_afo" style="filter:hue-rotate(168deg);background-image: url('https://up.be3.ovh/upload/1784028453.png');" data-toggle="tooltip" data-original-title="<div class=tt>Załaduj KWB</div>"></div>`;
